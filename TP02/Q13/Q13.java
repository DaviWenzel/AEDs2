...
public class Q13 {
    public static void gerarLog(long inicio, long fim, int comparacoes) {
        ...
        String nomelog = "matricula_mergesort.txt";
    ...
    public static void mergeSort(Show[] shows, int left, int right) {
        if (left < right) {
            int mid = (left + right) / 2;
            mergeSort(shows, left, mid);
            mergeSort(shows, mid + 1, right);
            merge(shows, left, mid, right);
        }
    }

    public static void merge(Show[] shows, int left, int mid, int right) {
        int n1 = mid - left + 1;
        int n2 = right - mid;
        ...
        System.arraycopy(shows, left, leftArray, 0, n1);
        System.arraycopy(shows, mid + 1, rightArray, 0, n2);
        ...
        while (i < n1 && j < n2) {
            ...
            String leftDuration = leftArray[i].getDuration();
            String rightDuration = rightArray[j].getDuration();

            int cmp = leftDuration.compareTo(rightDuration);

            if (cmp < 0) {
                shows[k] = leftArray[i];
                i++;
            } else if (cmp > 0) {
                shows[k] = rightArray[j];
                j++;
            } else {
    ...
    public static int compareShows(int a, int b) {
        String leftDuration = show[a].getDuration();
        String rightDuration = show[b].getDuration();
    ...
    public static void main(String[] args) {
        ...
        mergeSort(showsSelecionados, 0, i - 1);
